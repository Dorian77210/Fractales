public class Constant {
    ...
    public static final float X1 = -2.1f;
    public static final float X2 = 0.6f;
    public static final float Y1 = -1.2f;
    public static final int ZOOM = 500;
    public static final float Y2 = 1.2f;
    public static final int MAX_ITERATIONS = 100; //suite bornee

    public static final int SCALE = 200;
    public static final int SCALE_ITERATION = 15;
